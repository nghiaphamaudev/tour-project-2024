...
var showAlert = exports.showAlert = function showAlert(type, mess) {
  hideAlert();
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updateSeting.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " updated in successfully !!"));
          }
          _context.next = 11;
          break;
        case 8:
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51PE0P0Es5Pctmf48yIApoIHhyQFPcjscnPdeKnX9MiN4Prba2RQaH4JXyz4zTTt6g9ZeMWGRMt3pr5eGl2U0iokJ009kUk2b8t');
...
var _updateSeting = require("./updateSeting.js");
...
if (updateForm) {
  updateForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSeting.updateSetting)(form, 'data');
  });
}
if (userPasswordForm) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateSeting.updateSetting)({
